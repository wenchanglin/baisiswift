...
class SKScNavBar: UIView, SKLaunchMenuDelegate {
        ...
        set{
            ...
            UIView.animate(withDuration: 0.2, animations: { () -> Void in
                ...
                for btn in self.items {
                    ...
                    tempBtn.setTitleColor(UIColor.lightText, for: UIControlState())
                    tempBtn.titleLabel?.font = UIFont.systemFont(ofSize: 13)
                }
                itemBtn.setTitleColor(UIColor.lightText, for: UIControlState())
    ...
    fileprivate func getScNavContentAddScNavBarItemsWithItemsWidth(_ widths:NSArray) -> CGFloat {
        ...
        for index in 0 ..< itemsTitles.count {
            ...
            button.setTitleColor(UIColor.lightText, for: UIControlState())
            button.titleLabel?.font = UIFont.systemFont(ofSize: 13)
            button.addTarget(self, action: #selector(SKScNavBar.itemsBtnAction(_:)), for: UIControlEvents.touchUpInside)
        ...
        btn.setTitleColor(UIColor.lightText, for: UIControlState())
    ...
    fileprivate func setLineWithItensWidth(_ width:CGFloat) {
        line = UIView(frame: CGRect(x: 2, y: kScNavBarHeight - 3, width: width - 4, height: 1))
