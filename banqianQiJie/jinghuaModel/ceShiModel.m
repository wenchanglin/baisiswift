...
- (CGFloat)cellHeight{
    ...
    //长文本过长导致高度过高应受到高度约束
    _cellHeightWithoutComment = _cellHeight + _textHeight + 10;
    _cellHeight += (_textHeight > 120 ? 120 : _textHeight) + 10;
    ...
    if (![self.type isEqualToString: @"text"]) { //图片、视频
        ...
        _cellHeightWithoutComment += middleH + 10;
    }
    
    if (self.top_comments.count > 0){//评论
        textMaxSize = CGSizeMake(ScreenW - 2 * 10 - 10 -30, MAXFLOAT);
        ...
        for (int i=0 ; i <self.top_comments.count; i++){
            ...
            [attrStr addAttribute:NSForegroundColorAttributeName
                            value:[UIColor colorWithRed:62/255 green:114/255 blue:116/255 alpha:1]// (62, 114, 166)
